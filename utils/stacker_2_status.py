# file name: utils\stacker_2_status.py
...
@st.cache_data
def get_stacker_2_status():
    """
    Fetch the status of stacker 2 from the database.

    Returns:
        pandas.DataFrame: DataFrame containing the status of stacker 2.
    """
    qry = """
